      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">My Hazard Reports</h1>
              <p className="text-gray-600 mt-1">Submit and track workplace safety reports</p>
            </div>
            <button
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Get started by submitting your first hazard report</p>
            <button
              onClick={() => setShowForm(true)}
            ...
            {reports.map((report) => (
              <div key={report.id} className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-lg font-semibold text-gray-900 truncate">{report.hazard_title}</h3>
                ...
                {report.risk_level && (
                  <div className="mt-4">
                    ...
                    <span className="text-sm text-gray-900 ml-1">{report.risk_level}</span>
                  </div>
                )}
              </div>
            ))}
